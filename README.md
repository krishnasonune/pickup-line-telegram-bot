...
def start(update: Update, context: CallbackContext):
    update.message.reply_text("hii i am Pydevelop bot, i can help you to impress other by unqiue pick up lines get started by giving command /pickup and for help type /help")
...
def help(update: Update, context: CallbackContext):
    update.message.reply_text("if you like my pickup bot please share it with your friends, if you need any help contact to my owner on PyDeveloper")

updater = Updater(Token, use_context=True)
dp = updater.dispatcher

dp.add_handler(CommandHandler("pickup", pickup))
